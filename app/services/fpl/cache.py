...
def update_global_cache():
    ...
    if cached_latest_gw == current_latest_gw:
        print(f"⏩ No new global GW (still GW {current_latest_gw}). Skipping global cache update.")
        return
...
class FPLCacheUpdater(Thread):
    def __init__(self):
        ...
        self.queue = []  # league_ids waiting to update
...
# --- call this in your route when a new league_id is submitted ---
